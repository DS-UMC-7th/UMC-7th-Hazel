...
public class StoreRestController {
    ...
    public ApiResponse<StoreResponseDTO.MissionPreViewListDTO> getMissionByStore(@ExistMission @PathVariable(name = "storeId") Long storeId,@RequestParam(name = "page") Integer page){
        Page<Mission> missionPage = storeQueryService.getMissionsByStore(storeId, page);
